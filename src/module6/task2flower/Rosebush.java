...
public class Rosebush extends Rose {
    ...
    public Rosebush() throws RosebushWithNoRosesRuntimeException{

        try {
            throw new RosebushWithNoRosesException();
        }
        catch (RosebushWithNoRosesException e){
            System.out.println(e.getExceptionMessage());
            throw new RosebushWithNoRosesRuntimeException();
        }
    }
